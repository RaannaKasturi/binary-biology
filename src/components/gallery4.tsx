              ...
              >
                <Link href={item.href} target="_blank" rel="nofollow noreferrer" className="group rounded-xl">
                  <div className="group relative h-full min-h-[27rem] max-w-full overflow-hidden rounded-xl md:aspect-[5/4] lg:aspect-[16/9]">
                    ...
                    />
                    <div className="absolute -p-10 inset-0 h-full w-full bg-gradient-to-t from-black/85 via-black/60 to-transparent" />
                    <div className="absolute inset-x-0 bottom-0 flex flex-col items-start p-6 text-primary-foreground md:p-8">
                      <Badge variant={'outline'} className=" border-primary bg-primary-foreground text-primary">{item.label}</Badge>
