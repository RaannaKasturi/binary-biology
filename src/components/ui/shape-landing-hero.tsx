        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center items-center flex flex-col justify-center h-full pt-24 md:pt-32">
                    <Link target="_blank" rel="noopener noreferrer" href={"https://scientry.binarybiology.top"} >
                        <motion.div
                            custom={0}
                        ...
                        >
                            ...
                            < ChevronRight className="h-4 w-4 fill-white/60" />
                        </motion.div>
                    </Link>
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            <p className="text-2xl sm:text-3xl md:text-5xl bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">
                                {title0} <br /> {title1}
                            </p>
                            <div className="h-7" />
                            <span
